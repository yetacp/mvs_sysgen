...
//OBJ      DD  DSN=&ID..OBJ,DISP=(MOD,DELETE,DELETE),                   00002801
//             UNIT=SYSDA,VOL=SER=PUB000,                               00002802
//             SPACE=(CYL,0),DCB=SYS1.MACLIB                            00002803
...
//             SPACE=(CYL,(1,1,40)),DCB=SYS1.CMDPROC                    00003800
//CNTL     DD  DSN=&ID..CNTL,DISP=(,KEEP,DELETE),                       00003900
//             UNIT=SYSDA,VOL=SER=PUB000,                               00004000
//             SPACE=(CYL,(1,1,40)),DCB=SYS1.MACLIB                     00004100
//SOURCE   DD  DSN=&ID..SOURCE,DISP=(,KEEP,DELETE),                     00004200
//             UNIT=SYSDA,VOL=SER=PUB000,                               00004300
//             SPACE=(CYL,(2,2,40)),DCB=SYS1.MACLIB                     00004400
//OBJ      DD  DSN=&ID..OBJ,DISP=(,KEEP,DELETE),                        00004401
//             UNIT=SYSDA,VOL=SER=PUB000,                               00004402
//             SPACE=(CYL,(2,2,40)),DCB=SYS1.MACLIB                     00004403
//LOAD     DD  DSN=&ID..LOAD,DISP=(,KEEP,DELETE),                       00004500
//             UNIT=SYSDA,VOL=SER=PUB000,                               00004600
//             SPACE=(CYL,(4,1,20)),DCB=SYS1.LINKLIB                    00004700
//*                                                                     00004800
...
//*                                                                     00012001
//PW12B    EXEC PGM=PSU002,PARM=('\',                                   00012002
//             ' DEFINE NONVSAM (NAME(&ID..OBJ) DEVT(3380) ',           00012003
//             'VOL(PUB000))')                                          00012004
//STEPLIB  DD  DSN=SYSC.LINKLIB,DISP=SHR                                00012005
//SYSOUT   DD  DSN=&&IDCAMS,DISP=(MOD,PASS)                             00012006
//*                                                                     00012100
