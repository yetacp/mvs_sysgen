...
//SYSUT1   DD  DATA,DLM=@@
./ ADD NAME=CNSLOKUP
//NSLOOKUP JOB (JOB),'COMPILE NSLOOKUP',CLASS=A,MSGCLASS=A,NOTIFY=&SYSUID,
...
//       MAC2='SYS1.AMODGEN',                              
//       PARM.LKED='(XREF,LET,LIST,CAL)'                   
//ASM.SYSIN     DD DSN=SYSGEN.TCPIP.SAMPLIB(NCAT),DISP=SHR 
//LKED.SYSLMOD  DD DSN=SYS2.CMDLIB(NCAT),DISP=SHR          
//SYSLIB        DD DSN=SYS2.LINKLIB,DISP=SHR               
//SYSIN   DD DATA,DLM=$$                                   
 INCLUDE SYSLIB(EZASOH03)                                  
$$                                                         
//                                                         
./ ADD NAME=NCAT
