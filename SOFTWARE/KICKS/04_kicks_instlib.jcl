...
//SYSPRINT DD SYSOUT=*
//SYSIN DD *
 DELETE KICKS.SAMPLES.MURACH.CUSTMAS
 DELETE KICKS.SAMPLES.MURACH.PRODUCT
 DELETE KICKS.SAMPLES.MURACH.INVOICE
 DELETE KICKS.SAMPLES.MURACH.INVCTL
 SET MAXCC = 0
 DEFINE CLUSTER                                       -
      (NAME(KICKS.SAMPLES.MURACH.CUSTMAS) VOLUMES(PUB001) -
       TRACKS(15 15)  INDEXED                         -
       SHAREOPTIONS(1 3) UNIQUE                       -
       RECORDSIZE(118 118)                            -
       KEYS(6 0)                                      -
      )                                               -
     DATA ( NAME(KICKS.SAMPLES.MURACH.CUSTMAS.DATA))    -
    INDEX ( NAME(KICKS.SAMPLES.MURACH.CUSTMAS.INDEX))
 DEFINE CLUSTER                                       -
      (NAME(KICKS.SAMPLES.MURACH.PRODUCT) VOLUMES(PUB001) -
       TRACKS(15 15)  INDEXED                         -
       SHAREOPTIONS(1 3) UNIQUE                       -
    /* RECORDSIZE(39 39)     REC W/COMP-3  */         -
     ...
     DATA ( NAME(KICKS.SAMPLES.MURACH.PRODUCT.DATA))    -
    INDEX ( NAME(KICKS.SAMPLES.MURACH.PRODUCT.INDEX))
 DEFINE CLUSTER                                       -
      (NAME(KICKS.SAMPLES.MURACH.INVOICE) VOLUMES(PUB001) -
       TRACKS(15 15)  INDEXED                         -
       SHAREOPTIONS(1 3) UNIQUE                       -
    /* RECORDSIZE(275 275)   REC W/COMP-3  */         -
     ...
     DATA ( NAME(KICKS.SAMPLES.MURACH.INVOICE.DATA))    -
    INDEX ( NAME(KICKS.SAMPLES.MURACH.INVOICE.INDEX))
 DEFINE CLUSTER                                       -
      (NAME(KICKS.SAMPLES.MURACH.INVCTL) VOLUMES(PUB001) -
       TRACKS(15 15)  INDEXED                         -
       SHAREOPTIONS(1 3) UNIQUE                       -
       RECORDSIZE(7 7)                                -
       KEYS(1 0)                                      -
      )                                               -
     DATA ( NAME(KICKS.SAMPLES.MURACH.INVCTL.DATA))     -
    INDEX ( NAME(KICKS.SAMPLES.MURACH.INVCTL.INDEX))
/*
//*
...
//STEPLIB  DD DSN=KICKS.SYS.V1R5M0.SKIKLOAD,DISP=SHR
...
//SYSIN DD *
 REPRO INFILE(CUSTMAS) OUTDATASET(KICKS.SAMPLES.MURACH.CUSTMAS)
/*
//*
...
//SYSIN DD *
 REPRO INFILE(PRODUCT) OUTDATASET(KICKS.SAMPLES.MURACH.PRODUCT)
/*
//*
...
//SYSIN DD *
 REPRO INFILE(INVOICE) OUTDATASET(KICKS.SAMPLES.MURACH.INVOICE)
/*
//*
...
//SYSIN DD *
 REPRO INFILE(INVCTL) OUTDATASET(KICKS.SAMPLES.MURACH.INVCTL)
/*
//*
...
//SYSIN    DD *
 DEFINE ALTERNATEINDEX                                -
      (NAME(KICKS.SAMPLES.MURACH.INVOICE.AIX)           -
       RELATE(KICKS.SAMPLES.MURACH.INVOICE)             -
       VOLUMES(PUB001)                                -
     ...
     DATA ( NAME(KICKS.SAMPLES.MURACH.INVOICE.AIX.DATA)) -
    INDEX ( NAME(KICKS.SAMPLES.MURACH.INVOICE.AIX.INDEX))
 DEFINE PATH                                          -
      (NAME(KICKS.SAMPLES.MURACH.INVOICE.PATH)          -
       PATHENTRY(KICKS.SAMPLES.MURACH.INVOICE.AIX)      -
      )
 BLDINDEX INDATASET(KICKS.SAMPLES.MURACH.INVOICE)       -
           OUTDATASET(KICKS.SAMPLES.MURACH.INVOICE.AIX)
...
//SYSPRINT DD SYSOUT=*
//SYSIN DD *
 DELETE KICKS.SAMPLES.V1R5M0.SDB
 SET MAXCC = 0
 DEFINE CLUSTER                                      -
     (NAME(KICKS.SAMPLES.V1R5M0.SDB) VOLUMES(PUB001)   -
      CYLINDERS(10 10)  INDEXED                      -
      SHAREOPTIONS(1 3) UNIQUE                       -
      RECORDSIZE(92 92)                              -
      KEYS(14 0)                                     -
     )                                               -
    DATA ( NAME(KICKS.SAMPLES.V1R5M0.SDBDATA))         -
   INDEX ( NAME(KICKS.SAMPLES.V1R5M0.SDB.INDEX))
/*
//*
//* LOAD A DUMMY RECORD
//*
...
//SYSPRINT DD SYSOUT=*
//SYSIN    DD *
 REPRO INFILE(DUMYDATA) OUTDATASET(KICKS.SAMPLES.V1R5M0.SDB)
/*
//DUMYDATA DD *
...
//SYSPRINT DD SYSOUT=*
//SYSIN    DD *
 PRINT INDATASET(KICKS.SAMPLES.V1R5M0.SDB)
/*
...
//SYSIN DD *
 ...
 DELETE KICKS.TACDATA
 DELETE KICKS.SAMPLES.TACDATA
 SET MAXCC = 0
 DEFINE CLUSTER                                       -
      (NAME(KICKS.SAMPLES.TACDATA) VOLUMES(PUB001)             -
       TRACKS(15 15)  NONINDEXED                      -
       SHAREOPTIONS(1 3) UNIQUE                       -
       RECORDSIZE(204 204)                            -
      )                                               -
     DATA ( NAME(KICKS.SAMPLES.TACDATA.DATA))
/*
//*
...
//SYSIN DD *
 REPRO INFILE(TACDATA) OUTDATASET(KICKS.SAMPLES.TACDATA)
/*
//DELDEF EXEC PGM=IDCAMS,REGION=1024K
//SYSPRINT DD SYSOUT=*
//SYSIN DD *
 DELETE KICKS.SYS.V1R5M0.KIKINTRA
 SET MAXCC = 0
 DEFINE CLUSTER                                       -
      (NAME(KICKS.SYS.V1R5M0.KIKINTRA) INDEXED   -
       VOLUMES(PUB001)                                -
       TRACKS(15 15)                                  -
       SHAREOPTIONS(1 3) UNIQUE                       -
     ...
     DATA ( NAME(KICKS.SYS.V1R5M0.KIKINTRA.DATA)) -
    INDEX ( NAME(KICKS.SYS.V1R5M0.KIKINTRA.INDEX))
/*
//*
//* LOAD A DUMMY RECORD
//*
...
//SYSPRINT DD SYSOUT=*
//SYSIN    DD *
 REPRO INFILE(DUMYDATA) OUTDATASET(KICKS.SYS.V1R5M0.KIKINTRA)
/*
//DUMYDATA DD *
99999999999999999999999999999999999
/*
...
//SYSPRINT DD SYSOUT=*
//SYSIN DD *
 DELETE KICKS.SYS.V1R5M0.KIKTEMP
 SET MAXCC = 0
 DEFINE CLUSTER                                       -
      (NAME(KICKS.SYS.V1R5M0.KIKTEMP) INDEXED    -
       VOLUMES(PUB001)                                -
       TRACKS(15 15)                                  -
       SHAREOPTIONS(1 3) UNIQUE                       -
       RECORDSIZE(19 32767) SPANNED                   -
     ...
     DATA ( NAME(KICKS.SYS.V1R5M0.KIKTEMP.DATA)) -
    INDEX ( NAME(KICKS.SYS.V1R5M0.KIKTEMP.INDEX))
/*
//*
//* LOAD A DUMMY RECORD
//*
...
//SYSPRINT DD SYSOUT=*
//SYSIN    DD *
 REPRO INFILE(DUMYDATA) OUTDATASET(KICKS.SYS.V1R5M0.KIKTEMP)
/*
//DUMYDATA DD *
99999999999999999999999999999999999
/*
