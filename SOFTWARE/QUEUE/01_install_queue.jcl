...
//*
//*  HMVS01 IS MY USERID BUT IT PROBABLY IS NOT YOURS.
//*  CHANGE 'HMVS01' TO YOUR USERID OR OTHER SUITABLE VALUE(S).
//*
...
//SYSPRINT DD  SYSOUT=*
//SYSUT2   DD  DSN=SYSGEN.QUEUE.ASM,DISP=(NEW,CATLG),
//             UNIT=SYSALLDA,VOL=SER=PUB001,SPACE=(CYL,(10,5,20)),
//             DCB=(RECFM=FB,LRECL=80,BLKSIZE=19040)
//OBJECT   DD  DSN=SYSGEN.QUEUE.OBJ,DISP=(NEW,CATLG),
//             UNIT=SYSALLDA,VOL=SER=PUB001,SPACE=(CYL,(1,1,20)),
//             DCB=(RECFM=FB,LRECL=80,BLKSIZE=3120)
//SYSIN    DD  DATA,DLM=@@
./ ADD NAME=$GPDOC   8019-02202-20089-1753-00293-00021-00000-HMVS01    25
...
JQTQMAX  EQU   48             MAXIMUM NUMBER OF QUEUES            UF020
         MEND
./ ADD NAME=$RENAME  8003-02205-02308-1540-00045-00044-00000-HMVS01    00
...
./ ADD NAME=ACTIVE   8007-02166-02203-0019-00248-00209-00000-HMVS01    00
...
SYMNODEL DSECT ,                   RESTORE SYM CARD GENERATION    UF023
         END
./ ADD NAME=ALLOCATE 8000-02173-02173-1642-00078-00078-00000-HMVS01    00
...
SYMNODEL DSECT ,                   RESTORE SYM CARD GENERATION    UF023
         END
./ ADD NAME=BLD3270  8011-02173-03046-0345-00181-00229-00000-HMVS01    00
BLD3270  QSTART 'QUEUE COMMAND - BUILD 3270 DATA STREAM'
***********************************************************************
*                                                                     *
*   WRITTEN BY HMVS01 PRICE OF PRYCROFT SIX PTY LTD IN JUNE 2002.       *
*                                                                     *
...
SYMNODEL DSECT ,                   RESTORE SYM CARD GENERATION    UF023
         END
./ ADD NAME=C        8027-02153-20089-1637-00078-00067-00000-HMVS01    26
//QUEUEINS JOB (TSO),
//             'Receive XMI',
//             CLASS=A,
//             MSGCLASS=A,
...
//SYSLIB   DD  DISP=SHR,DSN=SYSGEN.QUEUE.ASM
...
//SYSTERM  DD  SYSOUT=*
//SYSPRINT DD  SYSOUT=*
//SYSIN    DD  DISP=SHR,DSN=SYSGEN.QUEUE.ASM(&M)
//SYSPUNCH DD  DISP=SHR,DSN=SYSGEN.QUEUE.OBJ(&M)
//        PEND
...
//SYSPRINT DD  SYSOUT=*
//SYSLIB   DD  DISP=SHR,DSN=SYSGEN.QUEUE.OBJ
//SYSLIN   DD  *
...
/*
//
./ ADD NAME=CB3270   8002-02173-03046-0351-00190-00188-00000-HMVS01    00
...
*                     HMVS01 PRICE, PRYCROFT SIX P/L.  JUNE 2002        *
*                                                                     *
...
SYMNODEL DSECT ,                   RESTORE SYM CARD GENERATION    UF023
         END
./ ADD NAME=CJOE     8004-02215-02216-0028-00094-00079-00000-HMVS01    00
...
//         DD  DISP=SHR,DSN=SYS1.MACLIB
//         DD  DISP=SHR,DSN=SYS1.AMODGEN
//SYSUT1   DD  SPACE=(CYL,(25,5)),UNIT=SYSALLDA
//SYSUT2   DD  SPACE=(CYL,(25,5)),UNIT=SYSALLDA
//SYSUT3   DD  SPACE=(CYL,(25,5)),UNIT=SYSALLDA
//SYSTERM  DD  SYSOUT=*
//SYSPRINT DD  SYSOUT=*
...
//SYSLMOD  DD  DSN=SYS2.CMDLIB,DISP=SHR
//SYSUT1   DD  UNIT=SYSALLDA,SPACE=(CYL,(8,1))
//SYSPRINT DD  SYSOUT=*
...
/*
//
./ ADD NAME=CPDDB    8002-02173-02202-0011-00176-00176-00000-HMVS01    00
...
DSNAME   DS    H
         DS    CL44
         END
./ ADD NAME=CSPIN    0110-96191-02306-1627-00430-00430-00000-HMVS01    00
...
****************************************************************  WGH
         END
./ ADD NAME=CTSO     8003-02173-03063-1455-00211-00202-00000-HMVS01    00
...
SYMNODEL DSECT ,                   RESTORE SYM CARD GENERATION    UF023
         END
./ ADD NAME=DDNAME   8014-02172-02311-1724-00293-00272-00000-HMVS01    00
...
SYMNODEL DSECT ,                   RESTORE SYM CARD GENERATION    UF023
         END
./ ADD NAME=DISPLAY  8057-02172-06336-1949-00543-00203-00000-HMVS01    17
...
./ ADD NAME=FINDJOB  8003-02199-02306-1046-00224-00206-00000-HMVS01    00
...
SYMNODEL DSECT ,                   RESTORE SYM CARD GENERATION    UF023
         END
./ ADD NAME=FINDPDDB 8000-02177-02177-1708-00101-00101-00000-HMVS01    00
...
SYMNODEL DSECT ,                   RESTORE SYM CARD GENERATION    UF023
         END
./ ADD NAME=FORMAT   8012-02172-06364-1725-00515-00480-00000-HMVS01    32
...
.ERROR2  IHBERMAC 54,,&MF                                               05800000
         MEXIT                                                          05850000
         MEND                                                           05900000
./ ADD NAME=HELP     8020-02172-07001-1444-00218-00163-00000-HMVS01    33
...
SYMNODEL DSECT ,                   RESTORE SYM CARD GENERATION    UF023
         END
./ ADD NAME=HEXDUMP  8000-02173-02173-0046-00171-00171-00000-HMVS01    00
...
SYMNODEL DSECT ,                   RESTORE SYM CARD GENERATION    UF023
         END
./ ADD NAME=INIT     8007-02153-06364-1637-00603-00532-00000-HMVS01    33
...
SYMNODEL DSECT ,                   RESTORE SYM CARD GENERATION    UF023
         END
./ ADD NAME=INITS    8009-02166-02188-2043-00152-00140-00000-HMVS01    00
...
SYMNODEL DSECT ,                   RESTORE SYM CARD GENERATION    UF023
         END
./ ADD NAME=JCL      8002-02215-02308-2134-00023-00024-00000-HMVS01    00
...
SYMNODEL DSECT ,                   RESTORE SYM CARD GENERATION    UF023
         END
./ ADD NAME=JLOG     8005-02212-07001-1441-00090-00081-00000-HMVS01    51
...
SYMNODEL DSECT ,                   RESTORE SYM CARD GENERATION    UF023
         END
./ ADD NAME=JMSG     8002-02215-02308-2134-00023-00024-00000-HMVS01    00
...
SYMNODEL DSECT ,                   RESTORE SYM CARD GENERATION    UF023
         END
./ ADD NAME=LIST     8001-02202-02202-2339-00132-00132-00000-HMVS01    00
...
SYMNODEL DSECT ,                   RESTORE SYM CARD GENERATION    UF023
         END
./ ADD NAME=LISTDS   8020-02166-03087-1844-00404-00281-00000-HMVS01    00
...
SYMNODEL DSECT ,                   RESTORE SYM CARD GENERATION    UF023
         END
./ ADD NAME=NEXT     8002-02306-02308-2000-00056-00060-00000-HMVS01    00
...
SYMNODEL DSECT ,                   RESTORE SYM CARD GENERATION    UF023
         END
./ ADD NAME=PARSE    8008-02173-03063-1444-00241-00231-00000-HMVS01    00
...
SYMNODEL DSECT ,                   RESTORE SYM CARD GENERATION    UF023
         END
./ ADD NAME=PRINT    8007-02173-20089-1554-00538-00507-00000-HMVS01    39
...
SYMNODEL DSECT ,                   RESTORE SYM CARD GENERATION    UF023
         END  ,                                                    FCI*
./ ADD NAME=QCOMMON  8034-02153-03046-0735-00408-00370-00000-HMVS01    00
         MACRO
         QCOMMON &CSECT=NO
...
QDOUTPUT DS    80CL160        OPTIMISED 3270 DATA STREAM OUTPUT AREA
         MEND
./ ADD NAME=QHEAD    8006-02166-03045-1456-00022-00013-00000-HMVS01    00
         MACRO
...
.MAINNO  ANOP
         ...
         MEND
./ ADD NAME=QSTOP    8001-02166-02166-0024-00009-00009-00000-HMVS01    00
         MACRO
&NAME    QSTOP &MAIN=NO
...
.MAINOK  ANOP
         ...
         MEND
./ ADD NAME=QTILT    8002-02166-03045-1456-00016-00016-00000-HMVS01    00
         MACRO
&NAME    QTILT &MESSAGE
&NAME    L     R15,QVDSPL     LOAD BASE REG
         USING QDISPLAY,R15   BASE REG FOR DISPLAY WORK AREA
         ...
         BR    R15            GO TO IT
         MEND
./ ADD NAME=QUEUE    8019-02166-03046-0714-00211-00197-00000-HMVS01    00
...
QCOMMON  QSTART TYPE=GLOBAL
         QCOMMON CSECT=YES
         END
./ ADD NAME=READSPC  8001-02166-03045-1458-00093-00093-00000-HMVS01    00
...
//SYSLIN   DD  *
 ...
 NAME    QUEUE(R)
/*
./ ADD NAME=REPOS    8016-02167-03046-0659-00354-00295-00000-HMVS01    00
...
COUNT    DS    D
         END
./ ADD NAME=SEARCH   8002-02166-02215-2139-00651-00633-00000-HMVS01    00
...
SYMNODEL DSECT ,                   RESTORE SYM CARD GENERATION    UF023
         END
./ ADD NAME=SYSLOG   8000-02202-02202-2300-00110-00110-00000-HMVS01    00
...
SYMNODEL DSECT ,                   RESTORE SYM CARD GENERATION    UF023
         END
./ ADD NAME=SYSOUT   8003-02173-02181-1553-00414-00413-00000-HMVS01    00
